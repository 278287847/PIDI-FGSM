...
tf.flags.DEFINE_string('output_dir', './DI_PIDM', 'Output directory with images.')
...
def stop(x, y, i, x_max, x_min, g1, g2, e):
    num_iter = FLAGS.num_iter
...
def main(_):
    ...
    with tf.Graph().as_default():
        ...
        e1 = tf.zeros(shape=batch_shape)
        x_adv, _, _, _, _, _, _, _ = tf.while_loop(stop, graph, [x_input, y, i, x_max, x_min, grad1, grad2, e1])
